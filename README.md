...
| Path | What it is |
|---|---|
| `rexinthewild.csv` | The benchmark: 954 questions, answer keys, topic tags, and source attribution |
...
All 485 were verified retrievable at the time of release.
...
assert all(a in o for a, o in zip(d.answer, d.options))   # holds for all 954
```
